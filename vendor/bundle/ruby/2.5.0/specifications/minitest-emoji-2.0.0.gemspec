# -*- encoding: utf-8 -*-
# stub: minitest-emoji 2.0.0 ruby lib

Gem::Specification.new do |s|
  s.name = "minitest-emoji".freeze
  s.version = "2.0.0"
  ...
  s.date = "2013-11-18"
  s.description = "Print out emoji for your test passes, fails, and skips".freeze
  ...
  s.homepage = "http://github.com/tenderlove/minitest-emoji".freeze
  s.licenses = ["MIT".freeze]
  s.rdoc_options = ["--main".freeze, "README.rdoc".freeze]
  s.rubygems_version = "3.0.6".freeze
  s.summary = "Print out emoji for your test passes, fails, and skips".freeze
